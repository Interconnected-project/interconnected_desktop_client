...
import DesktopSlaveP2PConnection from './DesktopSlaveP2PConnection';

export default class DesktopSlaveP2PConnectionBuilder
  implements SlaveP2PConnectionBuilder
{
  ...
  build(): SlaveP2PConnection {
    ...
    return new DesktopSlaveP2PConnection(
      this._masterId,
      this._masterRole,
      this._operationId,
