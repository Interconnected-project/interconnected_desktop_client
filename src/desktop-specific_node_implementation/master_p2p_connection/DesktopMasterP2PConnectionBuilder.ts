...
import DesktopMasterP2PConnection from './DesktopMasterP2PConnection';

export default class DesktopMasterP2PConenctionBuilder
  implements MasterP2PConnectionBuilder
{
  ...
  build(): MasterP2PConnection {
    ...
    return new DesktopMasterP2PConnection(
      this._slaveId,
      this._operationId,
